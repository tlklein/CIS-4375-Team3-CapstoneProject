...
This project is a full-stack web application designed for an individual barbershop owner. It includes a public-facing webpage for visitors and a private dashboard for the owner to manage clients, services, and events. The frontend is built using Vue.js, and the backend is powered by Node.js and Express, with a MySQL database hosted on AWS RDS.
